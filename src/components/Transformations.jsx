  ...
  const transformationsData = [
    {
      ...
      beforeImg: "./public/images_resources/Transformations/12b.jpg",
      afterImg: "./public/images_resources/Transformations/12a.jpg",
    },
    {
      id: 2,
      name: "Sarah K.",
      ...
      beforeImg: "./public/images_resources/Transformations/10b.jpg",
      afterImg: "./public/images_resources/Transformations/10a.jpg",
    },
    {
      id: 3,
      name: "Mike D.",
      ...
      beforeImg: "./public/images_resources/Transformations/4b.jpg",
      afterImg: "./public/images_resources/Transformations/4a.jpg",
    },
    {
      id: 4,
      name: "Omar Y.",
      ...
      beforeImg: "./public/images_resources/Transformations/2b.jpg",
      afterImg: "./public/images_resources/Transformations/2a.jpg",
    },
    {
      id: 5,
      ...
      duration: `6 ${t('months')}`,
      description: t('desc_clean_bulk'),
      beforeImg: "./public/images_resources/Transformations/11b.jpg",
      afterImg: "./public/images_resources/Transformations/11a.jpg",
    },
    {
      id: 6,
      name: "Omar Y.",
      duration: `6 ${t('months')}`,
      description: t('desc_clean_bulk'),
      beforeImg: "./public/images_resources/Transformations/ashb.jpg",
      afterImg: "./public/images_resources/Transformations/asha.jpg",
    },
  ];
